<div class="wrap about-wrap">
    <h1><?php printf( __( 'Welcome to Vimeo Video Post Lite %s', 'codeflavors-vimeo-video-post-lite' ), CVM_VERSION ); ?></h1>
    <p class="about-text"><?php printf( __( 'Thank you for installing CodeFlavors Vimeo Video Post Lite %s, the plugin that gives you the possibility to create WordPress posts from Vimeo searches, channels, user uploads or albums.', 'codeflavors-vimeo-video-post-lite' ), CVM_VERSION ); ?></p>
    ...
    <div class="feature-section one-col">
        <div class="col">
            ...
            <p class="lead-description"><?php _e( 'See how to set up Vimeo Video Post and start importing your Vimeo videos!', 'codeflavors-vimeo-video-post-lite' ); ?></p>
            <p>
                <?php printf(
                ...
                <?php printf(
                        ...
                        '<a href="' . cvm_docs_link( 'vimeo-video-post-wp-plugin/vimeo-oauth/' ) . '" target="_blank">',
                        '</a>'
                );?>
            </p>
    ...
    <div class="return-to-dashboard">
        ...
        |
        <a href="<?php echo cvm_docs_link( 'vimeo-video-post-wp-plugin/' ) ?>"
