<div class="wrap about-wrap">
    ...
    <div class="return-to-dashboard">
        ...
        <a href="<?php echo cvm_docs_link( 'vimeo-video-post-wp-video-import/automatic-import/' ) ;?>"><?php _e( 'Automatic Import explained', 'codeflavors-vimeo-video-post-lite' );?></a> |
        <a href="<?php echo cvm_docs_link( 'vimeo-video-post-wp-plugin-settings/import-options/' ) ;?>"><?php _e( 'Import options', 'codeflavors-vimeo-video-post-lite' );?></a>
    </div>
</div>