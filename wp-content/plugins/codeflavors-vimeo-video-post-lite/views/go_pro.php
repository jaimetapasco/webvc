<div class="wrap about-wrap">
	<h1>
		<?php _e('Vimeo Video Post - PRO', 'codeflavors-vimeo-video-post-lite')?>
	</h1>
	...
	<div class="class="feature-section one-col">
		<div class="col">
			...
			<p class="gopro-btn-holder">
				...
				<a class="button gopro-btn" href="<?php echo cvm_link( 'vimeo-video-post/' ) ;?>" target="_blank"><?php _e( 'Get PRO version!', 'codeflavors-vimeo-video-post-lite' ) ;?></a>
			</p>
		</div>
	</div>
<hr />
	<div class="class="feature-section two-col">
		<h2><?php _e( 'Vimeo Video Post Lite vs. PRO ', 'codeflavors-vimeo-video-post-lite' ) ;?></h2>
		<div class="two-col">
			<div class="col">
				<p>
				...
				<p>
					...
					<?php printf( __( 'Import Vimeo videos as WordPress posts by using the %smanual bulk import%s feature.', 'codeflavors-vimeo-video-post-lite' ), '<a href="' . cvm_docs_link( 'vimeo-video-post-wp-video-import/manual-bulk-import/' ) . '" target="_blank">', '</a>' );?>
				</p>
				<p>
					<span class="yes">PRO</span>
					<span class="yes">Lite</span>
				...
				<p>
					...
					<?php printf( __( 'Set global %svideo embed options%s for all your new videos from plugin settings.', 'codeflavors-vimeo-video-post-lite' ), '<a href="' . cvm_docs_link( 'vimeo-video-post-wp-plugin-settings/embed-options/' ) . '" target="_blank">', '</a>' );?>
				</p>
				<p>
					<span class="yes">PRO</span>
					<span class="yes">Lite</span>
			...
			<div class="col">
				...
				<p class="gopro-btn-holder extra-space">
					<a class="button try-pro-btn" href="https://vvp-demo.codeflavors.com/" target="_blank"><?php _e( 'Try PRO version', 'codeflavors-vimeo-video-post-lite' ) ;?></a>
					<a class="button gopro-btn" href="<?php echo cvm_link( 'vimeo-video-post/' ) ;?>" target="_blank"><?php _e( 'Go PRO!', 'codeflavors-vimeo-video-post-lite' ) ;?></a>
				</p>
			</div>
		</div>
	</div>
	...
	<div class="return-to-dashboard">
		<a href="<?php echo cvm_link('vimeo-video-post/'); ?>">Vimeo Video Post PRO</a>
	</div>
</div>