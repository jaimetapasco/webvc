                        ...
                        <td>
                            ...
                            <span class="description">
                                ...
                                <?php printf(
                                        ...
                                        '<a href="' . cvm_link('vimeo-video-post/') . '" target="_blank">',
                                        '</a>');
                                ?>
                            </span>
                        </td>
                ...
                <tr>
                    <th colspan="2">
                        ...
                        <p class="description">
                            ...
                            <br/>
							<?php printf( __( 'A step by step tutorial on how to create an app on Vimeo can be found %shere%s.', 'codeflavors-vimeo-video-post-lite' ), '<a href="' . cvm_link( 'vimeo-video-post-wp-plugin/vimeo-oauth/' ) . '" target="_blank">', '</a>' ); ?>
                        </p>
                        <hr />
